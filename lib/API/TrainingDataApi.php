...
if (!preg_match("/[0-9]+/", $transaction_id)) {
            throw new \InvalidArgumentException("invalid value for \"transaction_id\" when calling TrainingDataApi.commitExerciseTransaction, must conform to the pattern /[0-9]+/.");
        }
...
if (!preg_match("/[0-9]+/", $user_id)) {
            throw new \InvalidArgumentException("invalid value for \"user_id\" when calling TrainingDataApi.commitExerciseTransaction, must conform to the pattern /[0-9]+/.");
        }
...
if (!preg_match("/[0-9]+/", $user_id)) {
            throw new \InvalidArgumentException("invalid value for \"user_id\" when calling TrainingDataApi.createExerciseTransaction, must conform to the pattern /[0-9]+/.");
        }
...
if (!preg_match("/[0-9]+/", $type_id)) {
            throw new \InvalidArgumentException("invalid value for \"type_id\" when calling TrainingDataApi.getSamples, must conform to the pattern /[0-9]+/.");
        }
// verify the required parameter 'user_id' is set
        if ($user_id === null) {
            throw new \InvalidArgumentException(
...
if (!preg_match("/[0-9]+/", $transaction_id)) {
            throw new \InvalidArgumentException("invalid value for \"transaction_id\" when calling TrainingDataApi.listExercises, must conform to the pattern /[0-9]+/.");
        }
// verify the required parameter 'user_id' is set
        if ($user_id === null) {
            throw new \InvalidArgumentException(
...
if (!preg_match("/[0-9]+/", $user_id)) {
            throw new \InvalidArgumentException("invalid value for \"user_id\" when calling TrainingDataApi.listExercises, must conform to the pattern /[0-9]+/.");
        }
$resourcePath = '/v3/users/{user-id}/exercise-transactions/{transaction-id}';
        $formParams = [];
        $queryParams = [];
