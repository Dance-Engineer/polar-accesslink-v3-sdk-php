 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Exercise implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'exercise';
...
'detailed_sport_info' => 'getDetailedSportInfo'    ];
     ...
     * Sets id
     *
     * @param int $id Id of the trainining session
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param int $transaction_id Id of the exercise-transaction this training was transferred in
     *
     * @return $this
     */
