...
class ActivityLogs implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['activity_log'] = isset($data['activity_log']) ? $data['activity_log'] : null;
    }
     ...
     * Sets activity_log
     *
     * @param string[] $activity_log Absolute links to individual activity summaries within the transaction
     *
     * @return $this
     */
