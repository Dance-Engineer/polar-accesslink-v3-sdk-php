...
'weight_source' => 'getWeightSource'    ];
    ...
    const WEIGHT_SOURCE_SOURCE_MEASURED = '[SOURCE_MEASURED';
const WEIGHT_SOURCE_SOURCE_USER = 'SOURCE_USER]';
    ...
    {
        return [
            self::WEIGHT_SOURCE_SOURCE_MEASURED,
self::WEIGHT_SOURCE_SOURCE_USER,        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['weight_source'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getWeightSourceAllowableValues();
        if (!is_null($weight_source) && !in_array($weight_source, $allowedValues)) {
